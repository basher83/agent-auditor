...
1. **Use explicit domain term list** - Apply the exhaustive list from section 9.3 for consistent indicator counts
2. **Check decision guide PRESENCE only** - Use deterministic grep, not quality assessment
3. **Follow effectiveness scoring formula** - Use objective checks from Deterministic Effectiveness Scoring section
4. **Apply consolidation rules** - One issue per root cause, not per instance
5. **Apply dependency rules** - Don't double-count consequences

**Effectiveness Assessment:**

1. **Analyze trigger quality using quoted phrases** - Use deterministic extraction and specificity calculation
2. **Measure capability visibility** - Check 1-hop vs 2-hop navigation
3. **Think like Claude** - Will Claude discover and use this skill effectively?

**Balance:**

1. **List positive observations** - Include 3-5 things the skill does well
2. **Be objective** - Use thresholds, not subjective ranges
