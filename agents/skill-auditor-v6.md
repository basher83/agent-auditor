...
description: >
  ...
  comprehensive evidence collection. Uses skill_auditor.cli for consistent
...
**Script Version:** skill_auditor.cli (deterministic extraction)
...
```text
[Paste full output from python -m skill_auditor.cli run]
```
